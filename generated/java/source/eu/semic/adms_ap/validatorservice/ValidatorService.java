...
@WebServiceClient(name = "ValidatorService", 
                  ...
                  targetNamespace = "http://adms-ap.semic.eu/ValidatorService/") 
public class ValidatorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://adms-ap.semic.eu/ValidatorService/", "ValidatorService");
    public final static QName ValidatorServicePort = new QName("http://adms-ap.semic.eu/ValidatorService/", "ValidatorServicePort");
    static {
        URL url = null;
        try {
